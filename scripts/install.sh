...
echo "     docker run -d --name goclaw-pg -p 5432:5432 -e POSTGRES_PASSWORD=goclaw -e POSTGRES_DB=goclaw_v4 pgvector/pgvector:pg18"
echo ""
echo "  2. Set environment variables:"
echo "     export GOCLAW_POSTGRES_DSN='postgres://postgres:goclaw@localhost:5432/goclaw_v4?sslmode=disable'"
